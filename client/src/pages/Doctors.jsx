    ...
    <div style={{ padding: '40px 20px', maxWidth: '1200px', margin: '0 auto', minHeight: '80vh' }}>
      <div style={{ textAlign: 'center', marginBottom: '40px' }}>
        ...
        <p style={{ fontSize: '1.1rem', color: '#6b7280' }}>
          Meet our team of healthcare professionals across all clinics
        </p>
      </div>
      ...
      {loading ? (
        ...
        <>
          ...
          <div style={{ marginBottom: '30px', textAlign: 'center' }}>
            <select 
              onChange={(e) => setSelectedClinic(e.target.value ? clinics.find(c => c.id == e.target.value) : null)}
              style={{
                padding: '10px 15px',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px' }}>
            {allDoctors
              .filter(doctor => !selectedClinic || doctor.clinicId === selectedClinic.id)
              .map(doctor => (
                <div key={`${doctor.id}-${doctor.clinicId}`} style={{
                  padding: '25px',
                  background: 'white',
                  borderRadius: '15px',
                  ...
                  <p style={{ color: '#2563eb', fontSize: '0.9rem', marginBottom: '10px' }}>
                    {doctor.clinicName}
                  </p>
                  <button 
                    onClick={() => handleBookAppointment(doctor, { id: doctor.clinicId, name: doctor.clinicName })}
          ...
          {allDoctors.filter(doctor => !selectedClinic || doctor.clinicId === selectedClinic.id).length === 0 && (
